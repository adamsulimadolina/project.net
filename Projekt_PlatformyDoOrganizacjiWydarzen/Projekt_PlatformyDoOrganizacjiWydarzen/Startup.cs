    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<VerifyContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("VerifyContext")));
        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IServiceProvider serviceProvider, UserManager<Projekt_PlatformyDoOrganizacjiWydarzenUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            Seeds.SeedRoles(roleManager);
            Seeds.SeedUsers(userManager);
        }
    }
}
